  ...
  return (
    <div className="flex flex-col grow-0 justify-center mx-auto w-4/5 mb-6 md:w-3/5 xl:w-3/5">
      ...
      <div className="flex flex-col lg:w-4/5 lg:mx-auto">
        <h1 className="text-stone-700 text-4xl font-bold mb-8 mt-16 text-left">
          Submissions
        </h1>
        ...
        <ul>
          {subList.length > 0 ? (
            subList.map((item, item_index) => {
              return (
                <li
                  key={item_index}
                  onClick={() =>
                    routeToSubmissionPage(item.personal.performer_name.value)
                  }
                >
                  <div className="mt-4 bg-white shadow-md rounded mb-2 flex shrink-0 cursor-pointer hover:bg-stone-100">
                    <img
                    ...
                    <div className="flex flex-col p-4 max-h-60 h-max">
            ...
            <p className="justify-center mt-4 mb-2 flex shrink-0 lowercase text-stone-600 text-xs font-normal mb-4 xl:text-base">
