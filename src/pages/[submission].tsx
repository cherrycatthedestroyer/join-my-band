...
const Submission: React.FC<PropsFromRedux> = ({
  ...
  //w-4/5 xl:w-3/5 flex flex-col grow-0 justify-center mx-auto mb-6
  return (
    <div className="flex flex-col grow-0 justify-center mx-auto w-4/5 mb-6 md:w-3/5">
      <img
        src="/logo.png"
        alt="test-picture"
        className="xl:w-2/5 xl:self-center shrink-0 grow-0 scale-75 xl:mb-6 object-scale-down mt-4"
      />

      {submission.map((item, item_index) =>
        item_index === clientState.selectedSubmission ? (
          <div className="bg-white shadow-md rounded mb-2  flex flex-col xl:flex-row gap-2 xl:self-center">
            <img
            ...
            <div className="p-4 xl:w-1/2">
              ...
              <ul className="text-stone-600 list-disc list-inside text-xs font-normal mb-4 md:text-base text-nowrap">
                  ...
                  <div className="flex mb-2 justify-start gap-2">
                    {item.achievements.map((achievement, achievement_index) => (
                      <button
                        ...
                        type="button"
                        className={
                          clientState.selectedAchievement === achievement_index
                            ? activeSubmissionButtonStyling
                            : submissionButtonStyling
                        }
                      >
      ...
      <button
        type="submit"
        className="mt-6 hover:text-white text-stone-700 text-s py-2 px-3 rounded"
        onClick={routeToHome}
      >
        return home
      </button>
